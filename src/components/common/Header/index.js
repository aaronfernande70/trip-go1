...
export const Header = () => {
  return (
    <>
      <section className="">
        <div className="Header opacity-80 z-50 sticky bg-gray-800 flex gap-4 justify-between p-5">
        ...
        <div className="flex justify-center py-1 border-t bg-gray-600 border-t-gray-600 text-xs">
